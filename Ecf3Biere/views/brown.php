...
try {
    ...
    WHERE c.ID_COULEUR = 2"; // tt ls biere "Brunes"(2)

    $stmt = $db->query($query);
    $biereBrune = $stmt->fetchAll(PDO::FETCH_ASSOC);

    // Pagination
    $totalBieres = count($biereBrune);
    $totalPages = ceil($totalBieres / $biereParPage);
    $page = isset($_GET['page']) ? $_GET['page'] : 1;
    $offset = ($page - 1) * $biereParPage;
    $biere = array_slice($biereBrune, $offset, $biereParPage);
    ...
    <body class="transparent-bg">
        ...
        <div class="container h-100">
            ...
            <div class="pagination">
                ...
                <?php
                    $numPerPage = 62; // Nmbr de num de page affich/ligne
                    $numRows = ceil($totalPages / $numPerPage); // Nmbr lignes de num page
